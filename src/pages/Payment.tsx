...
export default function Payment() {
  ...
  const upiId = (campus?.settings as { payment?: { upi_id?: string } })?.payment?.upi_id || "jana20055@ybl";
        ...
        <div className="flex items-center justify-between px-4 h-14 max-w-2xl mx-auto w-full">
          <div className="flex items-center gap-3">
            <motion.button
              ...
              className="w-8 h-8 rounded-full bg-secondary text-foreground flex items-center justify-center"
            >
              {" "}
              <ArrowLeft size={18} />{" "}
            </motion.button>
                ...
                <div className="p-6 space-y-6">
                  <div className="space-y-3">
                    <Button
                      ...
                      className="w-full h-16 text-lg font-bold rounded-2xl bg-green-600 hover:bg-green-700 text-white shadow-lg shadow-green-500/20 flex items-center justify-between px-6 transition-all active:scale-[0.98]"
                    >
                  ...
                  <div
                    onClick={() => setStage("manual_help")}
                    className="group border border-border/60 p-4 rounded-xl flex items-center gap-4 cursor-pointer hover:bg-muted/30 hover:border-primary/30 transition-all"
                  >
                ...
                <div className="p-6 text-center space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-muted-foreground px-4">
                      Screenshot this QR, then open PhonePe/GPay scanner and select "Image".
                    </p>
                  </div>
                  <div className="text-xs text-muted-foreground font-medium uppercase tracking-wider">- OR -</div>
                  <div
                    onClick={copyUpiId}
                    className="flex items-center justify-between p-3 bg-muted/50 rounded-xl border border-border/50 cursor-pointer active:scale-[0.98] transition-transform"
                  >
                ...
                <div className="p-6 space-y-6">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      placeholder="Ex: 405829..."
                      className="h-12 font-mono text-lg bg-muted/20"
                      maxLength={12}
                    />
                  ...
                  <div className="space-y-2">
                    ...
                    {!screenshotPreview ? (
                      <div
                        ...
                        className="border-2 border-dashed border-border/50 rounded-xl h-32 flex flex-col items-center justify-center text-center cursor-pointer hover:bg-muted/30 transition-colors bg-muted/10"
                      >
                        {isCompressing ? (
                          ...
                          <>
                            {" "}
                            <div className="w-10 h-10 rounded-full bg-blue-500/10 flex items-center justify-center mb-2 text-blue-600">
                              {" "}
                              <Camera size={20} />{" "}
                            </div>{" "}
                            <span className="text-sm font-medium text-blue-600">Tap to Upload</span>{" "}
                          </>
                        )}
                      </div>
                    ) : (
                      <div className="relative rounded-xl overflow-hidden border border-border/50 h-40 bg-black">
                        {" "}
                        <img src={screenshotPreview} alt="Preview" className="w-full h-full object-contain" />{" "}
                        <button
                          onClick={removeScreenshot}
                          className="absolute top-2 right-2 w-8 h-8 rounded-full bg-black/60 text-white flex items-center justify-center backdrop-blur-sm"
                        >
                          <X size={16} />
                        </button>{" "}
                      </div>
